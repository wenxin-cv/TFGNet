...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'method',
        type=str,
        help=("Options: 'SR' 'facelib' 'dlib'. Set to 'all' to download all the checkpoint."))
    args = parser.parse_args()

    file_urls = {
        'SR': {
            'sr.pth': 'https://github.com/sczhou/CodeFormer/releases/download/v0.1.0/codeformer.pth'
        },
        'facelib': {
