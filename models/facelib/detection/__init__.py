...
from models.facelib.utils import load_file_from_url
from models.facelib.utils import download_pretrained_models
from models.facelib.detection.yolov5face.models.common import Conv
...
def init_yolov5face_model(model_name, device='cuda'):
    if model_name == 'YOLOv5l':
        model = YoloDetector(config_name='facelib/detection/yolov5face/checkpoint/yolov5l.yaml', device=device)
        model_url = 'https://github.com/sczhou/CodeFormer/releases/download/v0.1.0/yolov5l-face.pth'
    elif model_name == 'YOLOv5n':
        model = YoloDetector(config_name='facelib/detection/yolov5face/checkpoint/yolov5n.yaml', device=device)
